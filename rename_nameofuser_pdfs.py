#!/usr/bin/env python3
"""
PDF Renamer - Extracts 'Name of User' from Mercyhurst Prep PDFs and renames files
    ...
    try:
        with open(pdf_path, 'rb') as file:
            ...
            for page in reader.pages:
                ...
                match = re.search(r'Name of User\s*\n\s*([A-Za-z\s]+)', text)
                if match:
...
def rename_pdfs_in_folder(folder_path):
    ...
    pdf_files = list(folder.glob("Mercyhurst P*licy - *.pdf"))
    ...
    for pdf_file in sorted(pdf_files):
        ...
        if user_name:
            ...
            new_filename = f"Mercyhurst_Preparatory_School_Acceptable_Use_Policy_{safe_name}.pdf"
